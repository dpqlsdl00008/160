...
function start(mode, type, selection) {
    ...
    switch (status) {
        ...
        case 1: {
            qm.sendNextPrevS("최고의 폴암을 갖고 싶습니다!", 2);
            break;
        }
        case 2: {
        ...
        case 3: {
            qm.sendNextPrevS("당신이 메이플 월드 최고의 대장장이라고 알고 있습니다! 당신의 무기를 받고 싶습니다!", 2);    
            break;
        }
        case 4: {
            qm.sendAcceptDecline("이 늙은이는 이제 늙어서 좋은 무기 같은 것은 못 만든다네. 하지만 예전에 만든 것 중에 괜찮은 폴암이 있긴 하지... 하지만 넘겨줄 수는 없어. 이 녀석은 워낙에 날카로워서 주인마저도 다치게 할 녀석이거든. 그래도 꼭 갖고 싶은가?");
            break;
        }
        case 5: {
            qm.dispose();
