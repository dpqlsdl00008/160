...
function end(mode, type, selection) {
    ...
    switch (status) {
        ...
        case 1: {
            qm.forceStartQuest();
            if (qm.isQuestActive(20102) == true) {
                qm.changeJob(1200);
        ...
        case 2: {
            qm.sendNextPrev("이제 당신은 플레임 위자드세요. 이제 더 강해지고 싶다면 스탯창(S키)에서 적절한 스탯을 올리도록 하세요. 어려우시면 #b자동 분배#k로 하셔도 좋아요. 마법사에 익숙치 않은 분들께 무척 유용하답니다.");
            break;
        }
        case 3: {
