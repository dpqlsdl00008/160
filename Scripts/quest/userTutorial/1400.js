...
function start(mode, type, selection) {
    ...
    switch (status) {
        ...
        case 1: {
            var say = "빅토리아 아일랜드로 가면 전직관을 통해 원하는 직업으로 전직할 수 있어. 그러기 전에 미리 네가 원하는 직업을 알려주면 #b그들#k에게 널 추천하는 편지를 보내 줄게. 미리 소개 받고 가면 쉽게 전직할 수 있을 거야. 어떤 직업을 택할거야?#b";
            say += "\r\n#L0#강력한 힘과 체력의 전사";
