...
function start(mode, type, selection) {
    ...
    switch (status) {
        ...
        case 7: {
            qm.sendAcceptDecline("자, 설명은 여기까지 입니다. 이해 하셨습니까?\r\n\r\n#fUI/UIWindow.img/QuestIcon/4/0#\r\n#fUI/UIWindow.img/QuestIcon/8/0# 380 exp");
            break;
        }
        case 8: {
        ...
        case 11: {
            qm.sendNextPrev("왼편에 있는 포탈을 타고 쭉 가다 보면 수련의 숲이라는 곳에 갈 수 있을 겁니다. 그곳에 당신 같은 분을 위한 수련교관, 키쿠가 기다리고 있으니 그에게 가주세요. 레벨 10이 되기 전에는 서로 얼굴 보지 않았으면 좋겟군요."); 
            break;
        }
        case 12: {
            qm.dispose();
