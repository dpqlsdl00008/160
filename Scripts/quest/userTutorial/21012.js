...
function start(mode, type, selection) {
    ...
    switch (status) {
        ...
        case 2: {
            qm.sendAcceptDecline("아, 영웅이시니 검을 휘둘러 보면 뭔가 생각나실 수도 있지 않을까요? #b몬스터 사냥#k을 해보시면 어떻습니까?");
            break;
        }
        case 3: {
            qm.forceStartQuest();
            qm.sendNextS("마침 이 주변에 #r튜토리얼 무루#k들이 많이 사는데, 한 #r3마리#k만 퇴치해 보십시오. 뭔가 떠오를지도 모릅니다.", 1);
            break;
        }
        case 4: {
            qm.dispose();
            qm.sendNextPrevS("아, 혹시 스킬 사용법도 잊어버리신 건 아닙니까? #b스킬을 퀵 슬롯에 올려 놓으면 편하게 사용할 수 있습니다.#k 스킬뿐만 아니라 소비 아이템도 올릴 수 있으니 잘 활용하십시오.", 1);
            break;
        }
    }
}
