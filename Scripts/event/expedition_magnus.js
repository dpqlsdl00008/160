...
function spawnMagnus(eim) {
    var nMob = em.getMonster(8880000);
    eim.registerMonster(nMob);
    eim.getMapInstance(0).spawnMonsterOnGroundBelow(nMob, new java.awt.Point(1436, -1347));
}
