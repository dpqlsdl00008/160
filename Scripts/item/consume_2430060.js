var status = -1;
var aReward = [[5000233, 1], [1802371, 1]];
...
function action(mode, type, selection) {
    ...
    switch (status) {
        case 0: {
            var say = "#b마족 디아 패키지#k를 받으시겠어요?";
            say += "\r\n\r\n#fUI/UIWindow.img/Quest/reward#";
            say += "\r\n#i5000233# #b#z5000233# 1개#k";
            say += "\r\n#i1802371# #b#z1802371# 1개#k";
        ...
        case 1: {
            ...
            cm.gainItem(2430060, -1);
            cm.gainPet(5000233, "마족 디아", 1, 0, 100, 24 * 60 * 365, 101);
            cm.gainItem(1802371, 1);
