...
function action(mode, type, selection) {
    ...
    cm.getPlayer().getClient().sendPacket(Packages.tools.packet.CUserLocal.chatMsg(Packages.handling.ChatType.GameDesc, "피로 회복제 - 당근 시럽 미네랄 워터를 사용하여 피로도를 회복하였습니다. (" + cm.getPlayer().getOneInfoQuest(value, "fatigue_use") + "/5)"));
}