...
function action(mode, type, selection) {
    ...
    switch (status) {
        case 0: {
            if (cm.itemQuantity(2436231) < 10) {
                cm.dispose();
                return;
            }
            var say = "　 #d남겨진 칼로스의 의지#Cgray#에 손을 대자 강력한 힘이 느껴진다.　 강력한 힘 속에서 새로운 장비가 탄생하려 한다.";
        ...
        case 1: {
            ...
            var say = "　 #d남겨진 칼로스의 의지#Cgray#에서 #d에테르넬 장비#Cgray#가 탄생하려 한\r\n　 다.";
            say += "\r\n";
        ...
        case 2: {
            ...
            cm.gainItem(2436231, -10);
            cm.gainItem(nEthernell[s], 1);
            var say = "\r\n#d남겨진 칼로스의 의지#Cgray#에서 #d에테르넬 장비#Cgray#가 탄생했다.";
            say += "\r\n";
            say += "\r\n#fUI/UIWindow.img/QuestIcon/4/0#";
            say += "\r\n#i" + nEthernell[s] + "# #Cgreen##z" + nEthernell[s] + "##k";
            cm.sendNextS(say, 0, 0, 3005267);
            break;
        }
    }
}