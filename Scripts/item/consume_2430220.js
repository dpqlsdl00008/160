...
function action(mode, type, selection) {
    ...
    cm.getPlayer().getClient().sendPacket(Packages.tools.packet.CUserLocal.chatMsg(Packages.handling.ChatType.GameDesc, "피로 회복제 - 박하 비타민 믹스를 사용하여 피로도를 회복하였습니다. (" + cm.getPlayer().getOneInfoQuest(value, "fatigue_use") + "/5)"));
}