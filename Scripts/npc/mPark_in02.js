...
var mapname = [
["죽은 나무의 숲(Lv.162~171)", 954010000], 
["감시의 탑(Lv.165~175)", 954020000], 
["용의 둥지(Lv.175~185)", 954030000], 
["망각의 신전(Lv.192~198)", 954040000], 
["기사단의 요새(Lv.200~255)", 954050000], 
];
        ...
        case 2: {
            ...
            if (pMember != null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (ccUser != null) {
                        if (ccUser.getLevel() < min) {
                            cm.sendNext("\r\n파티원 중 레벨이 맞지 않는 파티원이 있습니다.\r\n#r" + min + "레벨 이상#k의 파티원만 입장 할 수 있습니다.");
                            return;
                        }
