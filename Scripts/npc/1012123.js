/*
	자동제작 스크립트를 통해 만들어진 스크립트 입니다.
	호남의영웅 에 의해 만들어 졌습니다.
	스크립트 이름 : 3004001
	스크립트가 있는 맵 : 메이플 15번가 : BEYOND 패션 (993050700)
*/
...
function action(mode, type, selection)
{
	...
	if (status == 0) {
		var msg = "";
		msg += "#fs11#안녕하세요. 안드로이드의 외형을 맡고 있는 #b세냐#k라고해요. #b새로운 외형#k를 원하고 있다면 저에게 맡겨보시는 것이 어때요? \r\n";
                        if (cm.getPlayer().getAndroid() != null) {
                        msg += "#fs11##b#L1#안드로이드 헤어 변경하기\r\n"; 
		msg += "#fs11##b#L2#안드로이드 얼굴 변경하기\r\n"; 
		msg += "#fs11##b#L3#색상변경하기\r\n"; 
                        } else {
		msg += "이런 안드로이드를 착용하고 있지않으시네요.\r\n"; 
                        }
		cm.sendSimple(msg);
	} else if (status ==1) {
		codyList = [];
		...
		switch (seld) {
			case 1:
				selStr += "#fs11#어떤 헤어로 변경 하실건가요?\r\n";
				selStr += "#L12#헤어 리스트 A#l#L13#헤어 리스트 B#l\r\n";
				selStr += "#L14#헤어 리스트 C#l#L15#헤어 리스트 D #e#r(최신 헤어)#l#k\r\n";
				/*if (cm.getPlayer().getAndroid() != null) {

					selStr += "\r\n\r\n#e#r#fs12#[안드로이드 헤어 변경하기]#k#b#n\r\n";
					selStr += "#L12##fs11# 헤어 리스트 A#l#L13# 헤어 리스트 B#l\r\n";
					selStr += "#L14# 헤어 리스트 C#l#L15# 헤어 리스트 D #e#r(최신 헤어)#l\r\n";

				}*/
				break;
			case 2:
				selStr += "#fs11#어떤 얼굴로 변경 하실건가요?\r\n";
				selStr += "#e #n#L16# 성형 리스트 A#l#L17#성형 리스트 B #e#r(최신 성형)#k#l\r\n";
				/*if (cm.getPlayer().getAndroid() != null) {
				...
				break;
			case 3:
				selStr += "#fs11#어느 염색을 하고싶어?\r\n\r\n#b";
				//selStr += "#L8#일반 염색하기\r\n#l";
				//selStr += "#L21#믹스 염색하기\r\n#l";
				selStr += "#L19#안드로이드의 헤어 색상#n변경하기\r\n#l";
				selStr += "#L18#안드로이드의 얼굴 색상변경하기#l#k\r\n ";
				selStr += "#L20#안드로이드의 피부 색상변경하기#l#k\r\n ";
				/*if (cm.getPlayer().getAndroid() != null) {
				...
				break;
			case 4:
				selStr += "#e#r[성별 전환, 기타 코디아이템 상점]#b#n\r\n";
				selStr += "#L10##fMap/MapHelper.img/minimap/party# #e"+gColor+"#n으로 성전환하기#l#b\r\n";
				selStr += "#L22##fMap/MapHelper.img/minimap/party# #e기타 코디아이템#n 상점#l\r\n";
				selStr += "#L24##fMap/MapHelper.img/minimap/party# #e검색 캐시#n 이용하기#l\r\n";
				//selStr += "#L23##fMap/MapHelper.img/minimap/party# #e캐시샵#n 이동하기 (구매불가)#l\r\n";
				break;
			case 20:
			cm.dispose();
			//cm.openNpc(9001062); 
			//cm.openNpcCustom(cm.getClient(), 2012036, "SearchFace");
				break;
		}
		/*
        if (cm.getPlayer().getAndroid() != null) {
...
if (seld < 10) {
	...
	else if(status == 2)
	{
		...
		if (SEL_00 == 21) {
			cm.dispose();
			cm.sendOkS("이런 얼굴의 믹스 렌즈는 아이템을 이용해야되요.", 4);
			return;
		}
		if (SEL_00 == 22) {
			cm.dispose();
		...
		selStr = "#fn돋움##fc0xFFFFFFFF#지금의 모습을 전혀 새로운 스타일로 바꿔 줄 수 있습니다. 지금 모습이 지겨워 졌다면 바꾸고 싶은 헤어를 천천히 고민해보세요.";
		switch(SEL_00)
		{
			case 1: // 헤어1
			case 12: // 헤어1
