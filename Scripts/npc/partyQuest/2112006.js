        ...
        case 1: {
            switch (selection) {
                case 0: {
                    ...
                    cm.sendNext("\r\n이럴 수가.. 줄리엣도 저와 똑같은 생각으로.. 마가티아의 전쟁을 막기 위해 이 곳에 온 거군요! 그 사람 혼자라면 위험합니다. 어서 서둘러야 해요!!");
                    cm.mapMessage(6, "로미오는 줄리엣의 편지를 보고 크게 당황하는 모습이다.");
                    break;
                }
                case 1: {
