...
public enum RecvPacketOpcode implements WritableIntValueHolder {
    ...
    USE_NEBULITE,
    FACE_EXPRESSION,
    HandleShowItemEffect,
    HandleBlingblingMonkey,
    WHEEL_OF_FORTUNE,
    NPC_TALK,
    NPC_TALK_MORE,
    HIRED_REMOTE,
    ...
    MONSTER_BOMB,
    HYPNOTIZE_DMG,
    HandleLapidificationState, // 183
    HandleMobSkillDelay, // 290
    HandleCygnusMist, // 295
    NPC_ACTION,
    ITEM_PICKUP,
    DAMAGE_REACTOR,
    SNOWBALL,
    ...
    DISPLAY_NODE,
    TOUCH_REACTOR,
    HandleNettPyramidMob,
    HandleNettPyramidSkill,
    RING_ACTION,
    SOLOMON,
    GACH_EXP,
    ...
    public static Properties getDefaultProperties() throws FileNotFoundException, IOException {
        ...
        FileInputStream fileInputStream = new FileInputStream("config/opcode/recvops.properties");
