...
public class CharacterTransfer implements Externalizable {
    ...
    public int characterid, accountid, fame, pvpExp, pvpPoints,
            ...
            partyid, messengerid, ACash, nxCredit, MaplePoints, recommend, Fanclub,
            mount_itemid, mount_exp, marriageId, maxhp, maxmp, hp, mp, exp,
            familyid, seniorid, junior1, junior2, currentrep, totalrep, todayrep, battleshipHP,
            guildContribution, totalWins, totalLosses, forgeEXP, mSkillPoints, honourexp, honourlevel,
            azwanCoinsAvail, azwanCoinsRedeemed, azwanECoinsAvail, azwanCCoinsAvail, headtitle, Roulette_Item, todaycharisma, todayinsight, todaywill, todaycraft, todaysense, todaycharm;
    public byte channel, gender, gmLevel, guildrank, alliancerank,
            fairyExp, cardStack, buddysize, world, initialSpawnPoint, skinColor, mount_level, mount_Fatigue, subcategory, trinityCount, rechargeCount, rechargeMobCount, flipthecoin, SurPlus;
    public long lastfametime, TranferTime, traningDamage;
    ...
    public boolean petAutoFeed, soul_stone, isFinalFiguration, dressup;
    public int glass_plusMorph;
    public int glass_minusMorph;
    public int exeedCount;
    public int exeedAttackCount;
    public int arcaneAim;
    ...
    public long familyBuffExpDuration;
    public int familyBuffExpEffect;
    public long familyBuffDropDuration;
    public int familyBuffDropEffect;
    public long healBuffDuration;
    public long takeDamageDelay;
    public int pierreHat;
    
    public long PQClock;
    public int PQClock_Time;
    ...
    public CharacterTransfer(final MapleCharacter chr) {
        ...
        this.todaycharisma = chr.getTodayCharisma();
        this.todayinsight = chr.getTodayInsight();
        this.todaywill = chr.getTodayWillpower();
        this.todaycraft = chr.getTodayCraft();
        this.todaysense = chr.getTodaySense();
        this.todaycharm = chr.getTodayCharm();
        this.pvpExp = chr.getTotalBattleExp();
        this.pvpPoints = chr.getBattlePoints();
        this.skinColor = chr.getSkin();
        this.job = chr.getJob();
        ...
        this.flipthecoin = chr.currentFTC();
        this.trinityCount = chr.getTrinityCount();
        this.rechargeCount = chr.getRechargeCount();
        this.SurPlus = chr.getSurPlus();
        this.rechargeMobCount = chr.getRechargeMobCount();
        this.powerTransfer = chr.getPowerTransfer();
        this.headtitle = chr.currentTitle();
        this.Roulette_Item = chr.getRouletteItem();
        this.recommend = chr.getRecommend();
        this.Fanclub = chr.getFanclub();
        this.soul_stone = chr.currentSoulStone();
        this.dressup = chr.isDressUp();
        ...
        this.familyBuffExpDuration = chr.getFamilyBuffExpDuration();
        this.familyBuffExpEffect = chr.getFamilyBuffExpEffect();
        this.familyBuffDropDuration = chr.getFamilyBuffDropDuration();
        this.familyBuffDropEffect = chr.getFamilyBuffDropEffect();
        ...
        this.glass_minusMorph = chr.getMinusOfGlassMorph();
        this.glass_plusMorph = chr.getPlusOfGlassMorph();
        this.exeedCount = chr.getExeedCount();
        this.exeedAttackCount = chr.getExeedAttackCount();
        this.arcaneAim = chr.getArcaneAim();
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        this.todayrep = in.readInt();
        this.battleshipHP = in.readInt();
        this.flipthecoin = in.readByte();
        this.trinityCount = in.readByte();
        this.rechargeCount = in.readByte();
        this.SurPlus = in.readByte();
        this.rechargeMobCount = in.readByte();
        this.powerTransfer = in.readInt();
        this.headtitle = in.readInt();
        this.Roulette_Item = in.readInt();
        this.recommend = in.readInt();
        this.Fanclub = in.readInt();
        ...
        this.todaycharisma = in.readInt();
        this.todayinsight = in.readInt();
        this.todaywill = in.readInt();
        this.todaycraft = in.readInt();
        this.todaysense = in.readInt();
        this.todaycharm = in.readInt();
        this.pvpExp = in.readInt();
        this.pvpPoints = in.readInt();
        final int mbooksize = in.readShort();
        this.glass_minusMorph = in.readInt();
        this.glass_plusMorph = in.readInt();
        this.exeedCount = in.readInt();
        this.exeedAttackCount = in.readInt();
        this.arcaneAim = in.readInt();
    ...
    public void writeExternal(final ObjectOutput out) throws IOException {
        ...
        out.writeInt(this.todayrep);
        out.writeInt(this.battleshipHP);
        out.writeByte(this.flipthecoin);
        out.writeByte(this.trinityCount);
        out.writeByte(this.rechargeCount);
        out.writeByte(this.SurPlus);
        out.writeByte(this.rechargeMobCount);
        out.writeInt(this.powerTransfer);
        out.writeInt(this.headtitle);
        out.writeInt(this.Roulette_Item);
        out.writeInt(this.recommend);
        out.writeInt(this.Fanclub);
        out.writeInt(this.totalWins);
        out.writeInt(this.totalLosses);
        out.writeObject(this.anticheat);
        out.writeUTF(this.tempIP);
        out.writeInt(this.todaycharisma);
        out.writeInt(this.todayinsight);
        out.writeInt(this.todaywill);
        out.writeInt(this.todaycraft);
        out.writeInt(this.todaysense);
        out.writeInt(this.todaycharm);
        ...
        out.writeInt(this.glass_minusMorph);
        out.writeInt(this.glass_plusMorph);
        out.writeInt(this.exeedCount);
        out.writeInt(this.exeedAttackCount);
        out.writeInt(this.arcaneAim);
