...
public class MapleSquad {
    ...
    public static enum MapleSquadType {
        bossbalrog(2), zak(2), chaoszak(2), horntail(2), chaosht(3), pinkbean(3), nmm_squad(2), vergamot(2), dunas(2), nibergen_squad(2), dunas2(2), core_blaze(2), aufheben(2), cwkpq(10), tokyo_2095(2), vonleon(3), scartar(2), cygnus(2), hilla(1), arkarium(3);
