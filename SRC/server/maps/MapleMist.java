...
public class MapleMist extends MapleMapObject {
    ...
    private MobSkill skill = null;
    private boolean isMobMist;
    private boolean isItemMist;
    private int skillDelay, skilllevel, isPoisonMist, ownerId, itemid;
    ...
    //fake
    public MapleMist(Rectangle mistPosition, int itemId) {
        this.mistPosition = mistPosition;
        //this.source = new MapleStatEffect();
        //this.source.setSourceId(-itemId);
        this.itemid = itemId;
        this.skilllevel = 1;
        isItemMist = true;
        isPoisonMist = 0;
