...
public class ChangeableStats extends OverrideMonsterStats {
    ...
    public ChangeableStats(MapleMonsterStats stats, OverrideMonsterStats ostats, int add) {
        hp = ostats.getHp() + add;
        exp = ostats.getExp() + add;
        mp = ostats.getMp() + add;
        watk = stats.getPhysicalAttack() * add;
        matk = stats.getMagicAttack() * add;
        acc = stats.getAcc() * add;
        eva = stats.getEva() + add;
        PDRate = stats.getPDRate() + add;
        MDRate = stats.getMDRate() + add;
        pushed = stats.getPushed() * add;
        level = stats.getLevel();
        speed = stats.getSpeed() * add;
    }
