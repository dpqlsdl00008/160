...
public class MapleEnergySphere extends MapleMapObject {
	...
	private int x, y, retitution, destroyDelay, startDelay, density, friction;
	private boolean ok, noGravity, noDeleteFromOthers, isDelayed;
	private ScheduledFuture<?> schedule;
	
	public MapleEnergySphere(boolean isDelayed, int y, int density, int friction, int destroyDelay, int startDelay) {
		this.setOk(true);
