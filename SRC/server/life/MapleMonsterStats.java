...
public class MapleMonsterStats {
    ...
    private byte cp, selfDestruction_action, tagColor, tagBgColor, rareItemDropLevel, HPDisplayType, summonType, PDRate, MDRate, category, heals, summonEffect;
    private short level, charismaEXP;
    private long hp, healThreshold, finalmaxHP;
    private int id, exp, mp, removeAfter, buffToGive, fixedDamage, selfDestruction_hp, dropItemPeriod, point, eva, acc, PhysicalAttack, MagicAttack, speed, partyBonusR, pushed, hideName;
    ...
    private boolean patrolMob = false;
    private int range, detectX, senseX;
    ...
    public void setSummonEffect(byte v1) {
        this.summonEffect = v1;
    }
