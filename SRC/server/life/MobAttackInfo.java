...
public class MobAttackInfo {
    ...
    private boolean isDeadlyAttack, notMissAttack;
    private int mpBurn, mpCon, fixDamage, attackCount, fixDamR;
    ...
    public void setNotMissAttack(boolean notMissAttack) {
    ...
    public void setAttackAfter(int attackAfter) {
        this.attackAfter = attackAfter;
    }

    public int getAttackAfter() {
        return attackAfter;
    }
