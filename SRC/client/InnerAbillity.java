...
public class InnerAbillity {
    ...
    public InnerSkillValueHolder TESTrenewSkill(byte x){
        byte realAbility = (byte) (x == 1 ? 1 : x == 2 ? 3 : x == 3 ? 5 : 1);
        return new InnerSkillValueHolder(70000015, (byte) realAbility, (byte) SkillFactory.getSkill(70000015).getMaxLevel(), (byte) 0);
    }
