...
public class MapleCharacterCards {
    ...
    public static Map<Integer, CardData> cards = new LinkedHashMap<>(); // order
    public List<Pair<Integer, Integer>> skills = new LinkedList<>(); // id, level
    ...
    public final static void connectData(final OutPacket mplew) {
        if (cards.isEmpty()) { // we don't show for new characters 
          //  mplew.writeZeroBytes(81); // 9 x 6
