...
public class MapleAndroid
    ...
    /* public static final MapleAndroid create(int itemid, int uniqueid) {
     ...
     return create(itemid, uniqueid, ((Integer)((List)aI
    nfo.left).get(Randomizer.nextInt(((List)aInfo.left).size()))).intValue(), ((Integer)((List)aInfo.right).get(Randomizer.nextInt(((List)aInfo.right).size()))).intValue());
     }*/
    public static final MapleAndroid create(int itemid, int uniqueid) {
        Triple<List<Integer>, List<Integer>, List<Integer>> aInfo;
        aInfo = MapleItemInformationProvider.getInstance().getAndroidInfo(itemid == 1662198 ? 79 : itemid == 1662006 ? 5 : itemid - 1661999);
        if (aInfo == null) {
            return null;
        }
        return create(itemid, uniqueid,
                ((Integer) ((List) aInfo.left).get(Randomizer.nextInt(((List) aInfo.left).size()))).intValue(),
                ((Integer) ((List) aInfo.right).get(Randomizer.nextInt(((List) aInfo.right).size()))).intValue());
    }
