...
public class MaplePet implements Serializable {
    ...
    public static enum PetFlag {
        ...
        PET_DRAW(0x100, 5190011, -1); //펫훈련스킬
        //   PET_DIALOGUE(0x200, 5190012, -1); //펫자이언트
    ...
    public static int getPetFlag(int itemid) {
        ...
        /*   if (stats.containsKey("giantPet") && stats.get("giantPet") == 1) {
         if ((flag & PetFlag.PET_DIALOGUE.i) == 0) {
         flag |= PetFlag.PET_DIALOGUE.i;
         }
         }*/
        return flag;
    }
